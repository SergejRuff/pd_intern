...
print("PROCESS 1: Import Data")
sys.stdout.flush()
# Define random state for reproducibility
random_state = 4
output_folder = "/hpc/scratch/project/ag-ixplain-cds/sergejruff/output/decisiontree/genotype"

df = pd.read_parquet("/hpc/scratch/project/ag-ixplain-cds/sergejruff/output/labed_data/ldata.parquet")

df = df.T

print("PROCESS 2: seperate into Feature and labels")
sys.stdout.flush()
...
print("PROCESS 3: generate Dummies")
sys.stdout.flush()
...
print("PROCESS 4: split into train, val and test")
sys.stdout.flush()
...
print("PROCESS 6: hyperparametertuning")
sys.stdout.flush()
...
print("PROCESS 7: test on best model")
sys.stdout.flush()
...
print("PROCESS 8: Evaluate Model on Val")
sys.stdout.flush()
...
print("Last PROCESS: Test on Tets")
sys.stdout.flush()
